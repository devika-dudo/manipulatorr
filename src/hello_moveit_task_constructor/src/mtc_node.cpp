  ...
  : Node("mtc_node", options)
{
  ...
  declare_parameter("controller_names", std::vector<std::string>{"arm_group_controller", "hand_controller"}, "Names of the controllers to use");

  // Robot configuration parameters
  declare_parameter("arm_group_name", "arm_group", "Name of the arm group in the SRDF");
  declare_parameter("gripper_group_name", "hand", "Name of the gripper group in the SRDF");
  declare_parameter("gripper_frame", "link_5", "Name of the gripper frame");
  declare_parameter("gripper_open_pose", "open", "Name of the gripper open pose");
  declare_parameter("gripper_close_pose", "close", "Name of the gripper closed pose");
  declare_parameter("arm_home_pose", "zero_pos", "Name of the arm home pose");
