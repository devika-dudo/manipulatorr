...
// Configure the planner with the specific group and planner
        ompl_planner_arm->setProperty("planning_pipeline", params.arm_group_name + "[RRTConnectkConfigDefault]");
...
// Configure the planner with the specific group and planner
ompl_planner_gripper->setProperty("planning_pipeline", params.gripper_group_name + "[RRTConnectkConfigDefault]");
