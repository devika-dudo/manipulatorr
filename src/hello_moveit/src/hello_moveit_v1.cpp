...
int main(int argc, char * argv[])
{
  ...
  auto const arm_target_pose = [&node]{
    ...
    msg.pose.position.x = 0.537;
    msg.pose.position.y = -0.512;
    msg.pose.position.z = 0.631;
    msg.pose.orientation.x = 0.242;
    msg.pose.orientation.y = 0.960;
    msg.pose.orientation.z = 0.138;
    msg.pose.orientation.w = -0.013;
    return msg;
  }();
