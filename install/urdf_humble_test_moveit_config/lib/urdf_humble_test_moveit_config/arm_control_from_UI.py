...
class Controller(Node):
    ...
    def __init__(self):
        ...
        self.panda_arm = self.panda.get_planning_component("arm_group")
    ...
    def move_to(self, x, y, z, xo, yo, zo, wo):
        ...
        self.panda_arm.set_goal_state(pose_stamped_msg = self.pose_goal, pose_link="link_5")
    ...
    def gripper_action(self, action):
        ...
        if action == 'open':
            joint_values = {"link_6": 5.3}
        elif action == 'close':
            joint_values = {"link_6": 1.0}
        else:
